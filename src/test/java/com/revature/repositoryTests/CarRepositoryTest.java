...
public class CarRepositoryTest {
	...
	public void findByIdTest() 
	{
		...
		Car c = repository.save(new Car(user, "Honda", "civic", 2018, "Zelda", "Red"));    //Have to save a new car because the generated ID is a random #
	...
	public void findByOwnerTest() 
	{
		...
		Car c = repository.save(new Car(user, "Honda", "civic", 2018, "Zelda", "Red"));
